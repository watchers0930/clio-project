...
- "기밀·보통" 옆 빈칸 → 빈 문자열("")
#### 정보(자료) 출처
- 참조 자료(소스 파일)의 파일명과 출처를 번호로 나열
- 형식: "1. [파일명] - [출처URL 또는 설명]\\n2. [파일명] - [출처]"
- 첫 번째 빈 셀에만 모든 내용을 넣으세요 (행 분리 X, 한 셀에 전부)
#### 보고 내용과 의견 (핵심 영역 — AI가 상세하게 작성)
- 첫 번째 빈 셀에만 모든 내용을 넣으세요 (행 분리 X, 한 셀에 전부)
- 번호 단락으로 구분: "1. [주제]\\n[상세 내용]\\n\\n2. [주제]\\n[상세 내용]"
- 참조 자료의 내용을 분석하고, 지시사항의 요청에 맞게 작성
- 배경→분석→근거→제안 순서로 논리적 서술
- 최소 200자 이상 상세하게 작성
#### 문제점
- 첫 번째 빈 셀에만 모든 내용을 넣으세요 (행 분리 X, 한 셀에 전부)
- 번호 단락으로 구분: "1. [문제점]\\n[상세 설명 및 대응 방안]\\n\\n2. [문제점]"
- 최소 1개 이상 구체적 리스크와 대응 방안을 함께 기술
