    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      <div className="w-full max-w-[280px] rounded-2xl border border-border bg-white shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-4 pb-4 pt-3">
          <div className="mb-3 flex h-16 items-end justify-end overflow-x-auto rounded-xl bg-surface-secondary px-4 py-2 text-right text-[26px] font-semibold text-foreground">
            {fmt(display)}
          </div>
