    ...
    <>
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-[10px]">
          <label className="inline-flex items-center gap-2.5 text-[12px] text-foreground-secondary cursor-pointer">
            <input
              type="checkbox"
              checked={docs.length > 0 && selectedDocIds.size === docs.length}
              onChange={onToggleSelectAll}
              className="m-0 block w-4 h-4 shrink-0 rounded border-border accent-[#0071e3] cursor-pointer"
            />
