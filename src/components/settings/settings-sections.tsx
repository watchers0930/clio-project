...
import { ArrowRight, Building2, FileText, PenLine, Plus, Share2, ShieldCheck, Trash2, Upload, Users, Pencil, Save, X, ArrowRightLeft, MessageSquare, CalendarDays, StickyNote, ShieldAlert, KeyRound, Briefcase, Banknote } from 'lucide-react';
...
const MENU_OPTIONS: MenuOption[] = [
  ...
  { key: 'work-ledger', label: '작업내역', description: '프로젝트 계약·수익·수금 일정을 관리합니다', icon: Briefcase },
  { key: 'bulk-transfer', label: '대량이체', description: '거래처 지급 건을 모아 하나은행 대량이체 파일을 생성합니다', icon: Banknote },
];
