  ...
  if (needPassword) {
    return (
      <div className="min-h-screen bg-[#f5f5f7] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-[#e5e5e7] shadow-lg w-full max-w-sm p-10 text-center">
          ...
          <input
            ...
            placeholder="비밀번호 입력"
            className="w-full px-4 py-3 rounded-xl border border-[#e5e5e7] bg-[#f5f5f7] text-sm text-[#1d1d1f] focus:outline-none focus:ring-2 focus:ring-[#0071e3] mb-3"
          />
          <button
            onClick={handlePasswordSubmit}
            disabled={pwLoading || !password.trim()}
            className="w-full py-3 rounded-xl bg-[#1d1d1f] text-white text-sm font-medium hover:bg-[#0071e3] transition-colors disabled:opacity-40"
          >
            {pwLoading ? '확인 중...' : '확인'}
          </button>
        ...
        {data.type === 'document' ? (
          <div className="bg-white rounded-2xl border border-[#e5e5e7] shadow-sm overflow-hidden">
            <div className="px-8 py-6 border-b border-[#e5e5e7]">
              <h1 className="text-2xl font-bold text-[#1d1d1f]">{data.title}</h1>
          ...
          <div className="bg-white rounded-2xl border border-[#e5e5e7] shadow-sm p-8 flex flex-col items-center text-center gap-5">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#1d1d1f]">{data.title}</h1>
              <p className="text-sm text-[#6e6e73] mt-1">
